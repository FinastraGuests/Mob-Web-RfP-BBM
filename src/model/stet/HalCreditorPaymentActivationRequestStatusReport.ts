 ...
 */
export interface HalCreditorPaymentActivationRequestStatusReport {
    /**
    ...
    PmtInfSts: models.TransactionGroupStatusCode;

    StsRsnInf?: models.StatusReasonInformation;

    TxInfAndSts: Array<models.PaymentTransactionStatusReport>;

    Links: models.PaymentReportLinks;
