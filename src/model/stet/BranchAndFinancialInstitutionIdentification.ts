...
/**
 * ISO20022: Set of elements used to uniquely and unambiguously identify a financial institution or a branch of a financial institution.  API: Only financial institution can be used. 
 */
export interface BranchAndFinancialInstitutionIdentification {
    FinInstnId: models.FinancialInstitutionIdentification;
