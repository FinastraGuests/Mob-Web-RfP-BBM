...
/**
 * ISO20022: Specifies the status of the payment information group. API: Mandatory. The following values are allowed.   - ACSC (AcceptedSettlementCompleted): Settlement on the debtor's account has been completed.   - ACSP (AcceptedSettlementInProcess): All preceding checks such as technical validation and customer profile were successful. Dynamic risk assessment is now also successful and therefore the payment initiation has been accepted for execution.   - RJCT (Rejected): Payment initiation  has been rejected. 
 */
    /**
    * ISO20022: Specifies the status of the payment information group. API: Mandatory. The following values are allowed.   - ACSC (AcceptedSettlementCompleted): Settlement on the debtor's account has been completed.   - ACSP (AcceptedSettlementInProcess): All preceding checks such as technical validation and customer profile were successful. Dynamic risk assessment is now also successful and therefore the payment initiation has been accepted for execution.   - RJCT (Rejected): Payment initiation  has been rejected. 
    */
export enum TransactionGroupStatusCode {
    ACSC = <any> 'ACSC',
    ACSP = <any> 'ACSP',
    RJCT = <any> 'RJCT'
}
