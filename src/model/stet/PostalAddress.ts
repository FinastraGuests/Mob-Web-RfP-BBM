...
export interface PostalAddress {
    /**
     * ISO20022: Country in which a person resides (the place of a person's home). In the case of a company, it is the country from which the affairs of that company are directed.  API: Country of the PISP. 
     */
    Ctry: string;
