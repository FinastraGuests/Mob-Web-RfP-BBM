...
/**
 * ISO20022: Provides detailed information on the status reason.  API: Can only be used in status equal to \"RJCT\". Only the following values are allowed: - CUST: The reject is due to the debtor: refusal or lack of liquidity - FF01: The reject is due to the original payment activation request which is invalid (syntax, structure or values)  
 */
    /**
    * ISO20022: Provides detailed information on the status reason.  API: Can only be used in status equal to \"RJCT\". Only the following values are allowed: - CUST: The reject is due to the debtor: refusal or lack of liquidity - FF01: The reject is due to the original payment activation request which is invalid (syntax, structure or values)  
    */
export enum StatusReasonChoice {
    CUST = <any> 'CUST',
    FF01 = <any> 'FF01'
}
