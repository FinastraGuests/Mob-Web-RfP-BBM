...
/**
 * links that can be used for further navigation when browsing Account Informations at one account level - gbal: link to the balances of a given account - gtxt: link to the transactions of a given account 
 */
export interface AccountLinks {
    Balances?: models.GenericLink;
