...
/**
 * Links that can be used for further navigation when browsing Account Informations at top level - self: link to the list of all available accounts 
 */
export interface PaginationLinks {
    Self: models.GenericLink;

    First?: models.GenericLink;

    Last?: models.GenericLink;

    Next?: models.GenericLink;

    Prev?: models.GenericLink;
