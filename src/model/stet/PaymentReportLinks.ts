...
/**
 * links that can be used for further navigation. - exct: link to execute a given transaction within the payment - ptrp: link to get a status report for the relevant payment - txrp: link to get a status report for a given transaction within the payment 
 */
export interface PaymentReportLinks {
    Self: models.GenericLink;

    Execution?: models.GenericLink;

    TransactionReport?: models.GenericLink;
