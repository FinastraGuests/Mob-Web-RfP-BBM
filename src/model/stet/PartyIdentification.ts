...
export interface PartyIdentification {
    /**
     * ISO20022: Name by which a party is known and which is usually used to identify that party.  API: Name of the PISP 
     */
    Nm: string;

    PstlAdr?: models.PostalAddress;

    Id?: models.PartyChoice;
