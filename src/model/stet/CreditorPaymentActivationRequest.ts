 ...
 */
export interface CreditorPaymentActivationRequest {
    GrpHdr: models.GroupHeader;

    PmtInf: models.PaymentInformation;

    SplmtryData?: models.SupplementaryData;

    ExtTransactionStatus?: models.ExtTransactionStatus;
}
