...
/**
 * ISO20022: Agreement under which or rules under which the transaction should be processed.  API: Only the <Cd> structure is allowed 
 */
export interface ServiceLevelChoice {
    /**
     * ISO20022: Specifies a pre-agreed service or level of service between the parties, as published in an external service level code list.  API: Only \"SEPA\" (SEPA Credit Transfer) or \"NURG\" (Other Credit Transfer) values are allowed 
     */
    Cd: ServiceLevelChoice.CdEnum;

}
export namespace ServiceLevelChoice {
    export     enum CdEnum {
        NURG = <any> 'NURG',
        SEPA = <any> 'SEPA'
    }
