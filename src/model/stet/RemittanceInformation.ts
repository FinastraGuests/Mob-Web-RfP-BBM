...
/**
 * ISO20022: Information supplied to enable the matching of an entry with the items that the transfer is intended to settle, such as commercial invoices in an accounts' receivable system.  API: Only <Ustrd> structure is allowed 
 */
export interface RemittanceInformation {
    /**
     * ISO20022: Information supplied to enable the matching/reconciliation of an entry with the items that the payment is intended to settle, such as commercial invoices in an accounts' receivable system, in an unstructured form.  API: Only one occurrence is allowed 
     */
    Ustrd: Array<string>;
