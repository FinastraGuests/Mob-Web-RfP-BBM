...
/**
 * links that can be used for further navigation when browsing Account Informations at one account level - parent-list: link to the list of all available accounts - self: link to the balances of a given account - gtxt: link to the transactions of a given account 
 */
export interface BalancesLinks {
    Self: models.GenericLink;

    Transactions?: models.GenericLink;
