 ...
 */
export interface SupplementaryDataEnvelope {
    /**
     * URL to be used by te ASPSP in order to transmit a succesful processing report
     */
    SuccessfulReportUrl: string;

    /**
     * URL to be used by te ASPSP in order to transmit a unsuccesful processing report
     */
