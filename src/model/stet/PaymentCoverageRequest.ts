 ...
 */
export interface PaymentCoverageRequest {
    Amount: models.AmountTypeChoice;
     ...
     */
    AccountIdType: PaymentCoverageRequest.AccountIdTypeEnum;

}
export namespace PaymentCoverageRequest {
    export     enum AccountIdTypeEnum {
        CardPan = <any> 'cardPan',
        Iban = <any> 'iban',
        Other = <any> 'other'
    }
